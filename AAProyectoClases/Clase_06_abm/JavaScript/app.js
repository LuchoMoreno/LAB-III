...
(function (Main) {
    ...
    function VerificarSiExiste() {
        ...
        var parametros = "queHago=VerificarSiExiste&correo=" + correo + "&clave=" + clave;
        var datos = "SELECT id, nombre, apellido, clave, perfil,estado FROM usuarios WHERE clave = " + clave + "AND WHERE correo = " + correo;
        ajax.Post("administracion.php", Success, parametros, Fail);
    }
    Main.VerificarSiExiste = VerificarSiExiste;
    //////////////////////////////////////////////////////
