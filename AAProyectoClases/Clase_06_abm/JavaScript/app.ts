...
namespace Main{
    ...
    export function VerificarSiExiste(): void {
        ...
        let parametros:string = `queHago=VerificarSiExiste&correo=` + correo + "&clave=" + clave;

        var datos : string = "SELECT id, nombre, apellido, clave, perfil,estado FROM usuarios WHERE clave = " + clave + "AND WHERE correo = " + correo;
